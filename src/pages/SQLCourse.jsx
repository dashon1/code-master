...
import { ArrowLeft, Play, CheckCircle, Clock, Code, Database } from "lucide-react";
  ...
  const loadData = async () => {
    try {
      const [coursesData, lessonsData, progressData, userData] = await Promise.all([
        base44.entities.Course.filter({ language: "sql" }, "order"),
        base44.entities.Lesson.filter({ language: "sql" }, "order"),
        ...
        <div className="flex items-center gap-4 mb-8">
          ...
          <div className="flex-1">
            <div className="flex items-center gap-3 mb-2">
              ...
              <h1 className="text-3xl font-bold text-gray-900">SQL Database Fundamentals</h1>
            </div>
            <div className="flex items-center gap-4">
              <Progress value={getProgressPercentage()} className="flex-1 max-w-xs h-2 [&>div]:bg-emerald-500" />
                ...
                <div className="space-y-1">
                  {lessons.map((lesson, index) => (
                    <button
                      ...
                      className={`w-full text-left p-4 hover:bg-emerald-50 transition-colors border-l-4 rounded-r-lg ${
              ...
              <Card className="border-0 shadow-lg bg-white/90 backdrop-blur-sm">
                <CardContent className="p-12 text-center">
                  ...
                  <p className="text-gray-600">
                    SQL lessons will be added soon. Check back later!
                  </p>
                </CardContent>
              </Card>
            )}
